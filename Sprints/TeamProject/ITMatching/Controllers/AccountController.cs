...
namespace ITMatching.Controllers
{
    public class AccountController : Controller
    {
        ...
        public IActionResult MeetingLog()
        {
            ...
            //    List<Meeting> meetingss = context.Meetings.Where(m => m.ClientId == itUser.Id && m.Status == "Closed").ToList();
            ...
            //    // MeetingLogsViewModel code
            //    //MeetingLogsViewModel tempMeetingLogModel = new MeetingLogsViewModel();
            //    //List<MeetingLogsViewModel> meetingInfo = new List<MeetingLogsViewModel>();

            //    // Meeting Log Model code
