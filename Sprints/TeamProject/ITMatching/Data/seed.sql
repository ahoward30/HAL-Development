...
INSERT INTO [FAQ](Question,Answer) VALUES('What do I if I submit a help request and I do not get matched up with an Expert?', 'You can re-submit your help request and try adding more tags that specify your IT issue. If you still see no results then there might not be an Expert who can help you out.');
...
INSERT INTO [FAQ](Question,Answer) VALUES('I am unable to verify my email?', 'Make sure to check all your folders including your spam folder in your email inbox. You may also go into the login page and click on the Resend Email Confirmation link to receive another verification link.');
...
INSERT INTO [FAQ](Question,Answer) VALUES('Can I change my email at any time?', 'Yes. You can change your email by selecting the Change Email tab on your account profile page. Do not forget to check your new email inbox for an email verification link.');
INSERT INTO [FAQ](Question,Answer) VALUES('My question is not answered here.', 'Contact us by email at itmatching@outlook.com');
