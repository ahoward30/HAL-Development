...
INSERT INTO [FAQ](Question,Answer) VALUES('What do I do if I submit a help request and I do not get matched up with an Expert?', 'You can re-submit your help request and try adding more tags that specify your IT issue. If you still see no results then there might not be an Expert who can help you out.');
